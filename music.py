...
class MusicGUI(object):
    ...
    def __init__(self, window, parent):
        ...
        # Create text labels:
        self.title_label = Label(window, text="Album Title")
        self.title_label.grid(row=1, column=12)

        self.artist_label = Label(window, text="Artist")
        self.artist_label.grid(row=1, column=16)

        self.year_label = Label(window, text="Year")
        self.year_label.grid(row=2, column=12)

        self.producer_label = Label(window, text="Producer")
        self.producer_label.grid(row=2, column=16)
        ...
        self.artist_value = StringVar()
        self.artist_box = Entry(window, textvariable=self.artist_value)
        self.artist_box.grid(row=1, column=17, columnspan=2)
        ...
        self.producer_box.grid(row=2, column=17, columnspan=2)
    ...
    def get_selected_row(self, event):
        ...
        self.artist_box.delete(0,END)
        self.artist_box.insert(END, self.selected_tuple[2])
...
class MusicGUI(object):
    ...
    def close_click(self):
        self.window.destroy()
>>>>>>> efbc63a2b7145c63d3fa5687e2eb950bbe510208
