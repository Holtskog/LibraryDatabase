...
class VideoGUI(object):
    """ This class creates the GUI and defines calls the behavior of the video section """
    ...
    def insert(self):
        """ This method sends the text variables to the inserting method in bakendVideos and displays a confirmation dialog when successfully inserted something"""
    ...
    def delete(self):
        """ 
        this method sends the selected index to the delete method in backendVideos.
    ...
    def update(self):
        ...
        update method in backendVideos and displays a confirmation when an update was completed
        """
        self.view_box.delete(0,END)
    ...
    def search(self):
        """
        This method allows sends whatever is entered in the entry boxes to the search method in backendVideos 
